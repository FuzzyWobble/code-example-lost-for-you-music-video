...
class LostForYou{
    ...
    createThree(){
        ...
        this.three.cam_dist_adjust = 1.0;
        if(this.three.isMobile)this.three.cam_dist_adjust = 1.6;
        this.three.camera.position.set(
            this.three.settings.camera.x,
            this.three.settings.camera.y,
            this.three.settings.camera.z*this.three.cam_dist_adjust
        );
    ...
    play(){
        ...
        if(this.isMobile)document.getElementById('uihelp').innerHTML =      'SCROLL TO ZOOM & DRAG TO ROTATE';
